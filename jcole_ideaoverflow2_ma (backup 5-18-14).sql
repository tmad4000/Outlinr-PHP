...
--
-- Host: localhost
-- Generation Time: May 18, 2014 at 07:00 AM
...
(888, 1396326044, 'Pitch-based scrolling interface', 'Pitch-based scrolling interface --  e.g. when you sing middle C, the document jumps to 50% mark. natural tool for voice recognition users/RSI/paralyzed patients #sound #signalprocessing ~jcole', 0, NULL, '', 0, 0, 204, 1, '', NULL, '2.4.203.136'),
(889, 1396326165, 'Shortcut Coach', 'Shortcut Coach -- watches you type and suggests shortcuts when you  can do stuff more efficiently  ~jcole', 0, NULL, '', 0, 0, 204, 0, '', NULL, '2.4.203.136'),
(890, 1396326255, 'Better collaborative knowledge spaces for universities', 'Better collaborative knowledge spaces for universities -- Better version of http://mitdoc.tk/  and http://ThingsYouDidntKnowExistedAtMIT.tk  ~jcole', 0, NULL, '', 0, 0, 204, 0, '', NULL, '2.4.203.136'),
(891, 1396326330, 'Telehackathon Networks', 'Telehackathon Networks -- Telehackathons are international hackathon events connected via VOIP utilities so that people in developing areas who would not necessarily be able to participate in certain events would be able to. We would be working on a grand-scale project of connecting hackers around the world. Our most recent planned event is a connection between Tanzinia and HackMIT in October. ~jcole', 0, NULL, '', 0, 0, 204, 0, '', NULL, '2.4.203.136'),
(893, 1396326623, 'Hack-o-meter / ThisIsHowYouLookRightNow', 'Hack-o-meter / ThisIsHowYouLookRightNow -- \\&quot;program that determines if youâ€™re in â€œhack modeâ€ or â€œlazy modeâ€ (alertness level) by using machine learning on keystrokes. Shows a picture of you from webcam when youâ€™re drowsy so you look at yourself and see you need to go to sleep.  Make hack-o-meter bar that shows your current power level!  ~jcole', 0, NULL, '', 0, 0, 204, 0, '', NULL, '2.4.203.136'),
(895, 1396326776, 'IdeaFlow', 'IdeaFlow -- Web platform that lets you type in idea, and it shows you all of the related ideas in the database. On a higher level, a \\&quot;gestalt processing system for society\\&quot; with impacts from organizing hackathon\\''s to running governments. My Grand Vision for this makes it the most profound project I have ever touched. Builds on a year of research; several offers to buy from major companies in hand http://ideaoverflowideplan.tk/ ~jcole', 2, NULL, '', 0, 0, 204, 0, '', NULL, '2.4.203.136'),
(896, 1396327427, 'WorldThroughYourEyes', 'WorldThroughYourEyes -- \\&quot; app for Google Glasses that tracks where user\\''s eyes are focusing and records video with that focus. This way, you could  compare how different people focus differently, and analyze what that does to their lives. Watching that video would truly allow you to see the world through another person\\''s eyes.  ~jcole', 0, NULL, '', 0, 0, 204, 0, '', NULL, '2.4.203.136'),
(897, 1396327089, 'MinimalistHomepages', 'MinimalistHomepages -- Instant way to make a minimalist homepage. How many of you don\\''t have homepages? You\\''re missing out! See more at http://minimalisthomepages.tk/ Let\\''s make this a facebook feature. What if we gathered all the projects everyone at MIT was working on ~jcole', 0, NULL, '', 0, 0, 204, 0, '', NULL, '2.4.203.136'),
(898, 1396327397, 'DeviceSymphony', 'DeviceSymphony -- mobile app/Web #app that plays the same note you are singing, or plays harmonics to the note youâ€™re playing. This way, you could put all your mobile devices out on a table and sing and be accompanied by a whole orchestra!  ~jcole', 0, NULL, '', 0, 0, 204, 0, '', NULL, '2.4.203.136'),
(899, 1396327396, 'EEG-based Slumping Detector', 'EEG-based Slumping Detector -- detect the pattern of brain activity that correlates with slumping / program that alerts me as is my posture begins to deteriorate so that I could correct it.. Could also just tells you to go to sleep. Helps people recover more quickly from RSI/carpal tunnel. Has interesting neuro/psych implications if it works as well. #signalprocessing ~jcole', 0, NULL, '', 0, 0, 204, 0, '', NULL, '2.4.203.136'),
(901, 1396326791, 'VocalJoystick -- #external', 'VocalJoystick -- http://melodi.ee.washington.edu/vj/ #external ~jcole', 2, NULL, '', 0, 0, 204, 0, '', NULL, '2.4.203.136'),
(903, 1396326793, 'Backup singer #app', 'Backup singer #app ~jcole', 0, NULL, '', 0, 0, 204, 0, '', NULL, '2.4.203.136'),
(904, 1396326794, 'DeviceSymphony ~jcole', 'DeviceSymphony ~jcole', 0, NULL, '', 0, 0, 204, 0, '', 1396330571, '2.4.203.136'),
(905, 1396326795, '#WorkflowSharing', '#WorkflowSharing ~jcole', 0, NULL, '', 0, 0, 204, 0, '', NULL, '2.4.203.136'),
(906, 1396326790, 'EagerPanda.com #external', 'EagerPanda.com #external ~jcole', 2, NULL, '', 0, 0, 204, 0, '', NULL, '2.4.203.136'),
(917, 1396370905, '#good', '#good', 0, NULL, '', 0, 0, 204, 0, '', NULL, '209.234.189.74'),
(918, 1396376006, '#it', '#it ~jcole', 0, NULL, '', 0, 0, 204, 0, '', 1396376035, '2.4.203.136'),
(929, 1396732855, 'Foodmom', 'Foodmom', 0, NULL, '', 0, 0, 204, 0, '', 1396732888, '92.232.117.253'),
(930, 1396732856, 'Foodmom', 'Foodmom', 0, NULL, '', 0, 0, 204, 0, '', 1396732877, '92.232.117.253'),
(931, 1396732998, 'Foodmom', 'Foodmom -- app that tells you what to cook and automatically orders ingredients (or makes you a shopping list). It could also suggest who to cook with by analysing online behaviour.', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(932, 1396733633, 'HackerCasting', 'HackerCasting -- twitch.tv for hackers: streaming your screen, keystrokes, mic, camera live while enthusiastically coding to inspire others and help them learn coding.', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(933, 1396733805, 'Skyline Midi Generator', 'Skyline Midi Generator -- a music translator for cities: image process a city skyline and turn it into a pleasant sound.', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(934, 1396733945, 'How to GAMIT', 'How to GAMIT -- (How to get around MIT): a publicly editable wiki based on the \\''How to GAMIT\\'' handbook', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(935, 1396734167, 'Backchannel for online lectures', 'Backchannel for online lectures -- a customisable interface that has a video on one side and a list of questions/comments that people have posted on the other. At any time, a user can pause the video and write a question/comment, which will be arranged chronologically in the document. People can upvote/downvote questions/comments. This will help to solve many of the concerns people have with online lectures, since students will get to ask questions in a time specific manner and a teacher will be able to answer them or make changes to lectures based on user feedback. ~holdenlee@alum.mit.edu #good ', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(936, 1396734191, 'WhatToDoAtMITRightNow', 'WhatToDoAtMITRightNow -- Events \\&quot;right now\\&quot; at MIT', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(937, 1396734277, 'Clicktracker', 'Clicktracker -- keep track of your clicking patterns (for instance, how much you switch tabs, and go back to check your email), and compare them on productive vs non-productive days. If you show someone how (and how much) they''re wasting time, they will shape up rather fast. ~holdenlee@alum.mit.edu', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(938, 1396734581, 'EveryDayOfYourLife', 'EveryDayOfYourLife -- a site which asks you a number of questions every day, such as &quot;Did you get out of your comfort zone?&quot;, &quot;Were you open minded?&quot;, &quot;What did you do wrong today, and how will you improve?&quot;, etc., and records your answers. It motivates you to stay on track with your goals by recording the number of yes''s in a row (COMBO!) and forcing you to admit when you haven''t done something. ~holdenlee@alum.mit.edu #good #lowhanging', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(939, 1396736242, 'Flow Me', 'Flow Me -- tool for making freestyling/rhyme/poetry unfairly easy. Suggests rhymes and alliterations as you type. Goal: to empower those with good messages and no writing skills.', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(940, 1396736338, 'Eye Tracking Heatmap from laptop webcam', 'Eye Tracking Heatmap from laptop webcam -- useful for evaluating how you read different websites, self-tracking/optimizing, and evaluating websites you build. You could make a script that lets you compare different people''s reading styles and evaluate the eye movement patterns of master readers. Also for online chess you could track eye movement patterns of novices vs masters as part of the coaching - this has been studied extensively.', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(941, 1396736444, 'Google Docs optimised for instant web publishing', 'Google Docs optimised for instant web publishing -- to replace my million google documents mapped to dot.tk domains, for instance, thingsyoudidntknowexistedatmit.tk, mitdoc.tk, foodslists.tk . A key feature is to give the pages memorable urls, a function currently served by easy-to-remember .tk domains. #big #good ~jcole', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(942, 1396736649, 'Photoquote', 'Photoquote -- app that lets you photograph a quote in a book, then searches online to find the boundaries of the quote you\\''re probably looking to note down, and adds the quote to your notebook. I find myself photographing quotes all the time. This is a big idea, and knowing the thread of quotes a person is interested in is a very powerful, and truly relevant advertising dataset.', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(943, 1396736697, 'I''veFallen', 'I''veFallen -- app that uses accelerometer data to detect when you (an old person) have fallen. If you don''t touch a button in 1 min cancelling emergency call, it calls your relatives, and next, emergency services, who check if you''re okay, and broadcasts your GPS location. #lowhanging', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(944, 1396736733, 'WhenToLeave', 'WhenToLeave -- app that tells you when to leave/what route to take so you donâ€™t get stuck in as bad of traffic.', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(945, 1396736790, 'Social ridesharing app', 'Social ridesharing app -- if your friends or friends of friends (on fb, linkedin, gmail/google+, etc) are going in a similar direction, they can be advised to pick you up, and vice versa. This would avoid legal problems with hitchhiking (not to mention safety issues). And then you could bring on \\&quot;friends of friends,\\&quot; people who work in same company as you, etc. to expand network into, ultimately, a general rideshare. #good', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(946, 1396736851, 'CabShare', 'CabShare -- app that tells you whether anyone else in your vicinity is taking a cab to the same place or in the same direction. What if Google Maps had an integrated \\&quot;call a cab\\&quot; button when you searched directions? And/or what if this were integrated with Social Rideshare/Cabshare? #good', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(947, 1396738641, 'Guitar hero typing tutor', 'Guitar hero typing tutor -- letters fall down the screen, and make music when they cross the bar. By the end of it, you could use your keyboard as a musical instrument, because each key correlates with the note and you will be fluent into the nature of that correlation.', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(948, 1396905640, 'PoliticalProgressBar', 'PoliticalProgressBar -- a simple graphical interface that voters can use to quickly see what government is trying to accomplish and how far it has gotten towards achieving its goals - it would perhaps take the form of a progress bar. The deeper significance of many news items can be revealed on interface such as this - if a certain piece of sustainable energy legislation passes, how much closer has it gotten us as a nation and planet to actually being energy sustainable for the forseeable future?', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(949, 1396905726, 'PlaylistForLife', 'PlaylistForLife -- looks at what you''re doing on pc and other devices and gives you the music for it! Or just compiles peopleâ€™s coding playlists, jogging playlists, etc and lets you look them up, mix and match, etc. Could use stereotyping after learning to predict tastes.', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(950, 1396905814, 'Mechanical Turk problems as reCaptcha', 'Mechanical Turk problems as reCaptcha -- service that lets you embed box that has people do specific types of mechanical turk tasks as the captcha challenges. Have them do 2: one is super verified, the other less so.  Fun fact: when you fill out some Google capchas it helps in Google street view to read house numbers.', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(951, 1396906052, 'Better Facebook Search', 'Better Facebook Search -- you should be able to say something like â€œJacob Cole MITâ€ and have it return Jacob Cole of MIT if such info is available', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(952, 1396906112, 'Roommate cancelling headphones', 'Roommate cancelling headphones -- uses roommate''s laptop microphone to seed noise cancelling algorithm in your headphones. #signalprocessing', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(953, 1396906168, 'Guard dog app', 'Guard dog app -- uses network of data from all devices in house to determine where strange sound is coming from. Triangulation pinpoints location. If burglar is carrying a cell phone, also listens to cell traffic src to pick up on location.', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(954, 1396906204, 'Trespasser App', 'Trespasser App -- detects if someone with a broadcasting device is in an off-limits area (perhaps this would be computer network app).', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(955, 1396913367, 'CloudDream', 'CloudDream -- creates cloud/ceiling popcorn patterns for artists to generate ideas for images. people see images in clouds: write a program that artists could use to overcome creativity barriers;  basically it would take a cloud formation image  and allow the artists to zoom in a specific part in incrementally improve something that resembles e.g. a giraffe until they have a full image.', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(956, 1396913429, 'GrabLunchWith', 'GrabLunchWith -- you press a button and it suggests where you should have lunch - tries to recommend friends to go to same place so they meet. #peoplematching #good #lowhanging\n', 0, NULL, '', 0, 0, 204, 1, '', NULL, '92.232.117.253'),
(957, 1396913591, 'Voice timbre extractor', 'Voice timbre extractor -- separates individual voices out of a noisy room. Relates to Andrew Ng''s machine learning approach to a similar problem http://see.stanford.edu/materials/aimlcs229/transcripts/MachineLearning-Lecture01.pdf #signalprocessing #machinelearning', 0, NULL, '', 0, 0, 204, 2, '', NULL, '92.232.117.253'),
(958, 1396914063, 'Academic conversations tool', 'Academic conversations tool -- matches people to each other that have mentioned titles to the same Wikipedia articles/links/quotes in their chats #peoplematching', 0, NULL, '', 0, 0, 204, 0, '', NULL, '92.232.117.253'),
(984, 1397830171, 'asdfkajsdkfjdfghjkasdhgjkhsdgjakdsghjkdfhkdfh', 'asdfkajsdkfjdfghjkasdhgjkhsdgjakdsghjkdfhkdfh ~timbl', 0, NULL, '', 0, 0, 204, 0, '', NULL, '128.30.7.200'),
(987, 1397831902, 'Enquire-within-upon-everything', 'Enquire-within-upon-everything ~timbl', 0, NULL, '', 0, 0, 204, 0, '', NULL, '128.30.7.200'),
(988, 1397831929, 'Rhizi', 'Rhizi ~timbl', 0, NULL, '', 0, 0, 204, 1, '', NULL, '128.30.7.200'),
(989, 1397869010, '#article I wish I could read Wikipedia like this', '#article I wish I could read Wikipedia like this -- step-by-step graph exploration interface http://www.gizmodo.co.uk/2014/04/i-wish-i-could-read-wikipedia-like-this/ ', 0, NULL, '', 0, 0, 204, 0, '', NULL, '192.76.7.198'),
(990, 1397951519, 'GestaltBox.tk', 'GestaltBox.tk -- #inprogress Platform  to make suggestion boxes for everything. Related to this website. Demo: http://jcr.stcatz.ox.ac.uk/ideas/', 0, NULL, '', 0, 0, 204, 0, '', NULL, '192.76.7.209'),
(991, 1398042997, 'DIY Gokart', 'DIY gokart -- ~Mark Liu http://www.meetup.com/San-Diego-Robotics-Club/events/137050562/ . Inspired by ~CharlesGuan #hardware', 0, NULL, '', 0, 0, 204, 1, '', NULL, '146.244.89.220'),
(992, 1398076561, 'Pachbel Alert', 'Pachelbel alert --  tells you if it hears pachelbel chords in song playing. Relatesd to Pachelbel rant www.youtube.com/watch?v=JdxkVQy7QLM and Axis of Awesome 4 chords songs mashup www.youtube.com/watch?v=5pidokakU4I #music', 0, NULL, '', 0, 0, 204, 0, '', NULL, '98.210.179.31'),
(993, 1398078628, 'Clearinghouse for campaign donations', 'Clearinghouse for campaign donations -- Currently Democrats and Republicans donate vast amounts of money to their parties to cancel out the media noise from the opposing party. My friend Sam Galler ~smgaller@gmail.com, who is super nice, massively connected, and a graduate student at Oxford on a Rhodes scholarship, proposed that we build a website that acts as a clearinghouse for donations to political campaigns in the US. If you donate to the Democratic Party it cancels out the donations to the Republican Party. The resulting bag of saved money goes to charity. He has the connections to get this website, if built, on frontline media, and would love to find people who want to work with him on it. I think this could save millions of dollars, and is a #lowhangingfruit #govtech #good', 0, NULL, '', 0, 0, 204, 0, '', NULL, '129.67.116.6'),
(994, 139826387, 'one - soicial app idea', 'one -- social app idea', 0, NULL, '', 0, 0, 204, 1, '', NULL, '70.15.254.6'),
(995, 139826389, 'One App', 'One App -- #existing app that uses common interests to help you meet awesome people. http://www.whatis1.com/app/', 0, NULL, '', 0, 0, 204, 0, '', NULL, '70.15.254.6'),
(1022, 139834958, 'Isis Incubator Oxford', 'Isis Incubator Oxford #accelerator #funding', 0, NULL, '', 0, 0, 204, 0, '', NULL, '163.1.94.97'),
(1023, 139834962, 'TSBC Grants', 'TSBC Grants -- Equity Free Grants, Technology Strategy Board, UK Gov #funding #grant', 0, NULL, '', 0, 0, 204, 0, '', NULL, '163.1.94.97'),
(1043, 1399311781, '#signalprocessing', '#signalprocessing', 0, NULL, '', 0, 0, 204, 0, '', NULL, '192.76.7.202'),
(1051, 1399595846, 'Homepage that recommends content to you and improves its recommendations based o', 'Homepage that recommends content to you and improves it''s recommendations based on your feedback #ml #nlp ', 0, NULL, '', 0, 0, 204, 0, '', NULL, '50.193.29.48'),
(1052, 139959588, 'stumbleupon.com', 'stumbleupon.com -- Learns to suggest websites to you based on your upvotes and downvotes. Also features netflix-like social matching.', 0, NULL, '', 0, 0, 204, 0, '', NULL, '50.193.29.48'),
(1053, 139959588, 'pandora.com', 'pandora.com -- Internet radio that learns your song preferences based on your upvotes and downvotes. #existing', 0, NULL, '', 0, 0, 204, 0, '', NULL, '50.193.29.48'),
(1054, 139959589, 'Google News', 'Google News -- #existing', 0, NULL, '', 0, 0, 204, 0, '', NULL, '50.193.29.48'),
(1056, 1399825458, 'WikiNets', 'WikiNets -- #inprogress A platform to collaboratively create and explore graphs of information; powers this site''s graph view interface https://github.com/willzeng/WikiNets', 0, NULL, '', 0, 0, 204, 0, '', NULL, '82.132.213.233'),
(1063, 139984072, 'API Companies', 'API Companies -- Companies like Parse.com or Twillio.com which provide APIs as their product #category', 0, NULL, '', 0, 0, 204, 0, '', NULL, '166.216.157.23'),
(1064, 140001887, '#guitar', '#guitar', 0, NULL, '', 0, 0, 204, 0, '', NULL, '24.199.0.34'),
(1065, 140001895, '#lyrics', '#lyrics', 0, NULL, '', 0, 0, 204, 0, '', NULL, '24.199.0.34'),
(1067, 140016016, 'rapgenius.com', 'rapgenius.com -- Interface to explore meanings of rap lyrics and other pieces of text #mediaannotation #existing', 0, NULL, '', 0, 0, 204, 0, '', NULL, '192.76.7.200'),
(1080, 140025879, 'Naptha, an amazing Chrome extension for modifying text in web images', 'Naptha, an amazing Chrome extension for modifying text in web images -- http://www.pcworld.com/article/2147320/amazing-chrome-extension-lets-you-copy-translate-or-modify-text-in-web-images.html ~KevinKwok #existing', 0, NULL, '', 0, 0, 204, 0, '', NULL, '129.67.110.191'),
(1081, 140025881, 'WordLens', 'WordLens -- That translates text seen through the camera #existing https://itunes.apple.com/gb/app/word-lens/id383463868?mt=8', 0, NULL, '', 0, 0, 204, 0, '', NULL, '129.67.110.191'),
(1082, 140025889, '#app', '#app', 0, NULL, '', 0, 0, 204, 0, '', NULL, '129.67.110.191'),
(1084, 140029141, '~KevinKwok', '~KevinKwok', 0, NULL, '', 0, 0, 204, 0, '', NULL, '129.67.110.191'),
(1085, 140029143, '#MIT', '#MIT', 0, NULL, '', 0, 0, 204, 0, '', NULL, '129.67.110.191');
...
(168, 'catz\n', '', '', '', ''),
(169, 'Hackathon Project Ideas (6.933)', '', '', '', ''),
(170, 'Web\n', '', '', '', ''),
(171, 'Oscar\n', '', '', '', ''),
(172, 'Jokes\n', '', '', '', ''),
(173, 'STFC Brainstorm\n', '', '', '', ''),
...
(593, 1390766121, 'Left over food given to students rather than bins', 'Left over food given to students rather than bins', 2, NULL, '', 0, 0, 80, 29, '', NULL, ''),
...
(608, 1390769264, 'Add what vegetables/sides/carbs will be at hall, for those of us who are less me', 'Add what vegetables/sides/carbs will be at hall, for those of us who are less meat fussy and more veg fussy.', 3, NULL, '', 0, 0, 80, 15, '', NULL, ''),
...
(651, 1390842997, 'College Cat', 'College Cat', 1, NULL, '', 0, 0, 80, 90, '', NULL, ''),
...
(655, 1390843955, 'Franklin Roosevelt style \\''Fireside chat\\'' with the OUSU rep at least once per w', 'Franklin Roosevelt style \\''Fireside chat\\'' with the OUSU rep at least once per week', 1, NULL, '', 0, 0, 80, 51, '', NULL, ''),
...
(657, 1390849400, '24 hour library', '24 hour library', 4, NULL, '', 0, 0, 80, 44, '', NULL, ''),
...
(671, 1390904910, 'Make hall sign-up include dietary requirements (i.e. gluten/dairy free)', 'Make hall sign-up include dietary requirements (i.e. gluten/dairy free)', 1, NULL, '', 0, 0, 80, 2, '', NULL, ''),
...
(677, 1391016098, 'PLEASE give vegetarians more Quorn', 'PLEASE give vegetarians more Quorn', 1, NULL, '', 0, 0, 80, 73, '', NULL, ''),
...
(712, 1391423831, 'Cocktails one night a week at the JCR bar', 'Cocktails one night a week at the JCR bar', 1, NULL, '', 0, 0, 80, 13, '', NULL, ''),
...
(743, 1392123361, 'OVENS. PLEASE. OVEENNSSS. need 2 cook. pls pls pls', 'OVENS. PLEASE. OVEENNSSS. need 2 cook. pls pls pls', 1, NULL, '', 0, 0, 80, 16, '', NULL, ''),
...
(770, 1393247355, 'Shloer for formal dinners, for people who don\\''t like/ can\\''t drink/ won\\''t drin', 'Shloer for formal dinners, for people who don\\''t like/ can\\''t drink/ won\\''t drink alcohol', 1, NULL, '', 0, 0, 80, 8, '', NULL, ''),
...
(778, 1393561132, 'æœ‰å¹¾é•·? ç”·ä»”é€šå¸¸ä¿‚æœ‰å¹¾é•·ä¼½ #èº«é«” #bodies ~Julia', 'æœ‰å¹¾é•·? ç”·ä»”é€šå¸¸ä¿‚æœ‰å¹¾é•·ä¼½ #èº«é«” #bodies ~Julia', 0, NULL, '', 0, 0, 138, 1, '', NULL, '163.1.112.171'),
...
(871, 1394329110, 'In gym, Complete set of posters detailing exercises', 'In gym, Complete set of posters detailing exercises', 0, NULL, '', 0, 0, 80, 3, '', NULL, '192.76.7.223'),
...
(916, 1396367573, 'fireman\\''s pole in the library', 'fireman\\''s pole in the library', 0, NULL, '', 0, 0, 80, 1, '', NULL, '192.76.7.211'),
...
(922, 1396482653, 'More intergenerational/student-faculty interaction', 'More intergenerational/student-faculty interaction ~jcole', 0, NULL, '', 0, 0, 80, 0, '', NULL, '90.8.52.215'),
...
(935, 1396734167, 'Backchannel for online lectures', 'Backchannel for online lectures -- a customisable interface that has a video on one side and a list of questions/comments that people have posted on the other. At any time, a user can pause the video and write a question/comment, which will be arranged chronologically in the document. People can upvote/downvote questions/comments. This will help to solve many of the concerns people have with online lectures, since students will get to ask questions in a time specific manner and a teacher will be able to answer them or make changes to lectures based on user feedback.', 0, NULL, '', 0, 0, 169, 0, '', NULL, '92.232.117.253'),
(936, 1396734191, 'WhatToDoAtMITRightNow', 'WhatToDoAtMITRightNow -- Events \\&quot;right now\\&quot; at MIT', 0, NULL, '', 0, 0, 169, 0, '', NULL, '92.232.117.253'),
(937, 1396734277, 'Clicktracker', 'Clicktracker -- keep track of your clicking patterns (for instance, how much you switch tabs, and go back to check your email), and compare them on productive vs non-productive days. If you show someone how (and how much) they\\''re wasting time, they will shape up rather fast.', 0, NULL, '', 0, 0, 169, 0, '', NULL, '92.232.117.253'),
(938, 1396734581, 'EveryDayOfYourLife', 'EveryDayOfYourLife -- a site which asks you a number of questions every day, such as \\&quot;Did you get out of your comfort zone?\\&quot;, \\&quot;Were you open minded?\\&quot;, \\&quot;What did you do wrong today, and how will you improve?\\&quot;, etc., and records your answers. It motivates you to stay on track with your goals by recording the number of yes\\''s in a row (COMBO!) and forcing you to admit when you haven\\''t done something.', 0, NULL, '', 0, 0, 169, 0, '', NULL, '92.232.117.253'),
...
(940, 1396736338, 'Eye Tracking Heatmap from laptop webcam', 'Eye Tracking Heatmap from laptop webcam -- useful for evaluating how you read different websites, self-tracking/optimizing, and evaluating websites you build. You could make a script that lets you compare different peopleâ€™s reading styles and evaluate the eye movement patterns of master readers. Also for online chess you could track eye movement patterns of novices vs masters as part of the coaching - this has been studied extensively.', 0, NULL, '', 0, 0, 169, 0, '', NULL, '92.232.117.253'),
(941, 1396736444, 'Google Docs optimised for instant web publishing', 'Google Docs optimised for instant web publishing -- an important facet is to combine with easy-to-remember .tk domains.', 0, NULL, '', 0, 0, 169, 0, '', NULL, '92.232.117.253'),
...
(943, 1396736697, 'I\\''veFallen', 'I\\''veFallen -- app that uses accelerometer data to detect when you (an old person) have fallen. If you donâ€™t touch a button in 1 min cancelling emergency call, it calls your relatives who check if youâ€™re okay, and broadcasts your GPS location.', 0, NULL, '', 0, 0, 169, 0, '', NULL, '92.232.117.253'),
...
(945, 1396736790, 'Social ridesharing app', 'Social ridesharing app -- if your friends or friends of friends (on fb, linkedin, gmail/google+, etc) are going in a similar direction, they can be advised to pick you up, and vice versa. This would avoid legal problems with hitchhiking (not to mention safety issues). And then you could bring on \\&quot;friends of friends,\\&quot; people who work in same company as you, etc. to expand network into, ultimately, a general rideshare.', 0, NULL, '', 0, 0, 169, 0, '', NULL, '92.232.117.253'),
(946, 1396736851, 'CabShare', 'CabShare -- app that tells you whether anyone else in your vicinity is taking a cab to the same place or in the same direction. What if Google Maps had an integrated \\&quot;call a cab\\&quot; button when you searched directions? And/or what if this were integrated with Social Rideshare/Cabshare?', 0, NULL, '', 0, 0, 169, 0, '', NULL, '92.232.117.253'),
...
(952, 1396906112, 'Roommate cancelling headphones', 'Roommate cancelling headphones -- uses roommate\\''s laptop microphone to seed noise cancelling algorithm in your headphones.', 0, NULL, '', 0, 0, 169, 0, '', NULL, '92.232.117.253'),
...
(956, 1396913429, 'GrabLunchWith', 'GrabLunchWith -- you press a button and it suggests where you should have lunch - tries to recommend friends to go to same place so they meet.', 0, NULL, '', 0, 0, 169, 1, '', NULL, '92.232.117.253'),
(957, 1396913591, 'Voice timbre extractor', 'Voice timbre extractor -- Pachelbel alert: tells you if it hears pachelbel chords in song playingtakes individual voices out of a crowd.', 0, NULL, '', 0, 0, 169, 2, '', NULL, '92.232.117.253'),
(958, 1396914063, 'Academic conversations tool', 'Academic conversations tool -- matches people to each other that have mentioned titles to the same Wikipedia articles/links/quotes in their chats', 0, NULL, '', 0, 0, 169, 0, '', NULL, '92.232.117.253'),
...
(984, 1397830171, 'asdfkajsdkfjdfghjkasdhgjkhsdgjakdsghjkdfhkdfh', 'asdfkajsdkfjdfghjkasdhgjkhsdgjakdsghjkdfhkdfh ~timbl', 0, NULL, '', 0, 0, 169, 0, '', NULL, '128.30.7.200'),
...
(989, 1397869010, 'I wish I could read Wikipedia like this', 'I wish I could read Wikipedia like this -- step-by-step graph exploration interface http://www.gizmodo.co.uk/2014/04/i-wish-i-could-read-wikipedia-like-this/ #article', 0, NULL, '', 0, 0, 169, 0, '', NULL, '192.76.7.198'),
(990, 1397951519, 'GestaltBox.tk', 'GestaltBox.tk', 0, NULL, '', 0, 0, 169, 0, '', NULL, '192.76.7.209'),
(991, 1398042997, 'gokart', 'gokart', 0, NULL, '', 0, 0, 169, 1, '', NULL, '146.244.89.220'),
(992, 1398076561, 'Test', 'Test', 0, NULL, '', 0, 0, 169, 0, '', NULL, '98.210.179.31'),
(993, 1398078628, 'Clearinghouse for campaign donations', 'Clearinghouse for campaign donations -- Currently Democrats and Republicans donate vast amounts of money to their parties to cancel out the media noise from the opposing party. My friend Sam Galler ~smgaller@gmail.com, who is super nice, massively connected, and a graduate student at Oxford on a Rhodes scholarship, proposed that we build a website that acts as a clearinghouse for donations to political campaigns in the US. If you donate to the Democratic Party it cancels out the donations to the Republican Party. The resulting bag of saved money goes to charity. He has the connections to get this website, if built, on frontline media, and would love to find people who want to work with him on it. I think this could save millions of dollars, and is a #lowhangingfruit #govtech', 0, NULL, '', 0, 0, 169, 0, '', NULL, '129.67.116.6'),
(994, 1398263879, 'one - soicial app idea', 'one - soicial app idea', 0, NULL, '', 0, 0, 169, 1, '', NULL, '70.15.254.6'),
(995, 1398263892, 'One App', 'One App', 0, NULL, '', 0, 0, 169, 0, '', NULL, '70.15.254.6'),
...
(1022, 1398349580, 'Isis Incubator Oxford', 'Isis Incubator Oxford', 0, NULL, '', 0, 0, 169, 0, '', NULL, '163.1.94.97'),
(1023, 1398349629, 'TSBC Grants', 'TSBC Grants -- Equity Free Grants, Technology Strategy Board, UK Gov', 0, NULL, '', 0, 0, 169, 0, '', NULL, '163.1.94.97'),
...
(1047, 1399337010, 'Art loan program', 'Art loan program -- So students can put nice pieces of art in their rooms. Like New College or MIT', 0, NULL, '', 0, 0, 80, 2, '', NULL, '192.76.7.202'),
(1048, 1399337064, 'Permission to walk on the circle of grass in the center of college', 'Permission to walk on the circle of grass in the center of college -- It would be a wonderful place to sit and study, do tai chi, or throw a Frisbee', 0, NULL, '', 0, 0, 80, 3, '', NULL, '192.76.7.202'),
...
(1051, 1399595846, 'Homepage recommends content to you and improves it\\''s recommendations based on y', 'Homepage recommends content to you and improves it\\''s recommendations based on your feedback #ml #nlp', 0, NULL, '', 0, 0, 169, 0, '', NULL, '50.193.29.48'),
(1052, 1399595883, 'stumbleupon.com', 'stumbleupon.com', 0, NULL, '', 0, 0, 169, 0, '', NULL, '50.193.29.48'),
(1053, 1399595887, 'pandora', 'pandora', 0, NULL, '', 0, 0, 169, 0, '', NULL, '50.193.29.48'),
(1054, 1399595899, 'Google News', 'Google News', 0, NULL, '', 0, 0, 169, 0, '', NULL, '50.193.29.48'),
...
(1056, 1399825458, 'WikiNets', 'WikiNets', 0, NULL, '', 0, 0, 169, 0, '', NULL, '82.132.213.233'),
...
(1063, 1399840727, 'API Companies', 'API Companies', 0, NULL, '', 0, 0, 169, 0, '', NULL, '166.216.157.23'),
(1064, 1400018874, 'guitar', 'guitar', 0, NULL, '', 0, 0, 169, 0, '', NULL, '24.199.0.34'),
(1065, 1400018951, 'lyrics', 'lyrics', 0, NULL, '', 0, 0, 169, 0, '', NULL, '24.199.0.34'),
(1066, 1400075839, '~sam', '~sam', 0, NULL, '', 0, 0, 138, 0, '', NULL, '192.76.7.205'),
(1067, 1400160165, 'rap genius', 'rap genius', 0, NULL, '', 0, 0, 169, 0, '', NULL, '192.76.7.200'),
...
(1080, 1400258793, 'Naptha, an amazing Chrome extension for modifying text in web images', 'Naptha, an amazing Chrome extension for modifying text in web images -- http://www.pcworld.com/article/2147320/amazing-chrome-extension-lets-you-copy-translate-or-modify-text-in-web-images.html ~KevinKwok', 0, NULL, '', 0, 0, 169, 0, '', NULL, '129.67.110.191'),
(1081, 1400258818, 'WordLens', 'WordLens -- That translates text seen through the camera', 0, NULL, '', 0, 0, 169, 0, '', NULL, '129.67.110.191'),
(1082, 1400258890, '#app', '#app', 0, NULL, '', 0, 0, 169, 0, '', NULL, '129.67.110.191'),
...
(1084, 1400291412, '~KevinKwok', '~KevinKwok', 0, NULL, '', 0, 0, 169, 0, '', NULL, '129.67.110.191'),
(1085, 1400291432, '#MIT', '#MIT', 0, NULL, '', 0, 0, 169, 0, '', NULL, '129.67.110.191'),
...
(1087, 1400356006, 'all jcr emails to stop putting \\''[insert department here] love\\'' at the end of t', 'all jcr emails to stop putting \\''[insert department here] love\\'' at the end of their emails. you don\\''t really love me', 0, NULL, '', 0, 0, 80, 0, '', NULL, '129.67.37.109'),
