  ...
  <div class="container-fluid">
    <div class="row margin-vertical">
      ...
      <div class="col-sm-6 right middle margin-vertical">
        <a href="https://github.com/login/oauth/authorize?client_id=3429c5dd62f9e39cf646&scope=user&redirect_uri=http://dev.ideajoin.com/github_oauth.php" class="link-button">Login with Github</a>
