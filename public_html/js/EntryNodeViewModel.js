	...
	*/
	...
	this.render = function() {
		...
		if(this.entryNodeModel.pid!==null) {
			...
			var starCol = "<td class='star-idea'><span class='big-status status'>"+'<a href="#" rel="popover" data-content="'+progEntry +this.entryNodeModel.metric+'" data-original-title="'+statusTable[this.entryNodeModel.status]+'">'+"<i class='ion-record status sc"+this.entryNodeModel.status +"'></i></a></span></td>";
