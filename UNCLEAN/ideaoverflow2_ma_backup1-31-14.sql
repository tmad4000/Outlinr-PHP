...
--
-- Host: localhost
-- Generation Time: Jan 31, 2014 at 02:33 AM
...
(27, 558, '#dsf adsf', 1390791114, '', NULL);
...
INSERT INTO `ideamaps` (`mapid`, `mapname`, `email`) VALUES
...
(88, '#person david\n', ''),
(89, 'l\n', ''),
(90, 'GitHub Issues List for this Tool', ''),
(91, '#person Jacob\n', ''),
(92, '#person Oscar\n', ''),
(93, 'Startup Ideas\n', ''),
(94, 'MIT VW Hackathon\n', ''),
...
(218, 1373430132, 'what is this?', 'what is this?', 0, NULL, '', '0', 0, 12, 0, '', NULL),
...
(140, 1367923045, 'Perform the following transformations on the state', 'Perform the following transformations on the state budget: Income Tax (+0.95%), Capital Gains Tax (-5.75%), Sales Tax (-1.75%), Gas Tax (+0.15%) ~Deval Patrick''s budget, see Proposals.', 1, NULL, '', '0', 187, 1, 0, '140', NULL),
...
(190, 1369636312, 'Abundant, fulfilling work-play', 'Abundant, fulfilling work-play', 2, 30, '% citizens working just as much as they want', '0', 189, 0, 3, '187/189/', NULL),
...
(199, 1369649400, 'Misc Suggestions', 'Misc Suggestions', 2, NULL, '', '0', 197, 3, 0, '197/', NULL),
...
(187, 1369635993, 'Utopia', 'Utopia -- Turn MA into a prosperous, nurturing bastion of human flourishing', 2, 47, '', '0', 0, 0, 4, '', NULL),
...
(293, 1378070491, 'Matador drone', 'Matador drone -- hold up ared cape, it paws the air, and then charges', 0, NULL, '', '0', 0, 54, 1, '', NULL),
...
(397, 1381609817, 'Arbor.js -- http', 'Arbor.js -- http://arborjs.org/echolalia/ Step by step exploration that looks promising but is bouncy. Maybe we can make it work', 0, NULL, '', '0', 0, 83, 2, '', NULL),
(398, 1381759487, 'The Hog Roast', 'The Hog Roast -- The Hog Roast is Oxford\\''s most eco-friendly cafe - a social enterprise set up by a student in June 2013. There are plenty of opportunities for students to get involved, from baking to event organising. ', 0, NULL, '', '0', 0, 84, 2, '', NULL),
(399, 1381759524, 'Oxford Soup', 'Oxford Soup -- Microfunding dinners in the community', 0, NULL, '', '0', 0, 84, 2, '', NULL),
(400, 1381867765, 'Swimming pool #longshot', 'Swimming pool #longshot', 0, NULL, '', '0', 0, 80, 1, '', NULL),
(401, 1381867793, 'Decaffeinated teas after hall', 'Decaffeinated teas after hall', 0, NULL, '', '0', 0, 80, 1, '', NULL),
(402, 1381867808, 'Free teas in the JCR', 'Free teas in the JCR', 0, NULL, '', '0', 0, 80, 2, '', NULL),
(403, 1381872589, 'Found a Catz philosophy society', 'Found a Catz philosophy society', 0, NULL, '', '0', 0, 80, 1, '', NULL),
(404, 1381872619, 'Make use of the table tennis tables more by having', 'Make use of the table tennis tables more by having someone run a casual sessions', 0, NULL, '', '0', 0, 80, 2, '', NULL),
...
(408, 1381880505, 'Catz chef should give food advice to other college', 'Catz chef should give food advice to other colleges -- starting with New college breakfast', 0, NULL, '', '0', 0, 80, 2, '', NULL),
...
(419, 1383259942, 'College animal: for exam time --', 'College animal: for exam time -- other colleges have cats/puppies', 0, NULL, '', '0', 0, 80, 2, '', NULL),
(430, 1383268262, 'Make St. Catz suggestion box site', 'Make St. Catz suggestion box site', 2, 50, '% core features implemented', '0', 0, 80, 3, '', NULL),
(431, 1383337803, 'Make a random generator for entz costumes!', 'Make a random generator for entz costumes!', 0, NULL, '', '0', 0, 80, 1, '', NULL),
(432, 1383337832, 'ggh', 'ggh', 0, NULL, '', '0', 0, 80, 1, '', NULL),
(433, 1383337841, 'jk', 'jk', 0, NULL, '', '0', 0, 80, 0, '', NULL),
(428, 1383265877, 'dfds', 'dfds', 0, NULL, '', '0', 0, 80, 0, '', NULL),
(429, 1383266454, 'dsf', 'dsf', 0, NULL, '', '0', 0, 80, 3, '', NULL),
(434, 1383342055, 'testshhghg', 'testshhghg', 0, NULL, '', '0', 0, 80, 0, '', NULL),
(435, 1383342099, 'dsda', 'dsda', 0, NULL, '', '0', 0, 80, 0, '', NULL),
(436, 1383342143, 'fgg', 'fgg', 0, NULL, '', '0', 0, 80, 0, '', NULL),
(437, 1383385870, 'Free stuff #yolo', 'Free stuff #yolo', 0, NULL, '', '0', 0, 80, 0, '', NULL),
(438, 1383389171, '#test lets go', '#test lets go', 0, NULL, '', '0', 0, 80, 0, '', NULL),
(439, 1383391711, 'new post #yolo', 'new post #yolo', 0, NULL, '', '0', 0, 80, 0, '', NULL),
(440, 1383391830, '#yolo #test', '#yolo #test', 0, NULL, '', '0', 0, 80, 0, '', NULL),
(441, 1383393008, 'next time #yolo #swag', 'next time #yolo #swag', 0, NULL, '', '0', 0, 80, 1, '', NULL),
(442, 1383403419, 'testing #123 leggo #insta', 'testing #123 leggo #insta', 0, NULL, '', '0', 0, 80, 0, '', NULL),
(443, 1383956209, 'Decaffeinated teas after hall', 'Decaffeinated teas after hall', 0, NULL, '', '0', 0, 80, 0, '', NULL),
(444, 1384035197, 'test #niche', 'test #niche', 0, NULL, '', '0', 0, 80, 0, '', 1390492441),
(445, 1384123729, 'new #yolo #swag broken', 'new #yolo #swag broken', 0, NULL, '', '0', 0, 80, 0, '', 1390492440),
(446, 1384172613, '#yolo #test nice', '#yolo #test nice', 0, NULL, '', '0', 0, 80, 0, '', 1390492439),
(447, 1387723172, 'testing #123', 'testing #123', 0, NULL, '', '0', 0, 80, 0, '', 1390492438),
(448, 1387723182, 'once upon #a #time', 'once upon #a #time', 0, NULL, '', '0', 0, 80, 1, '', 1390492437),
(449, 1387894113, 'test\n\n\n\n\n\n\n\n\n\n\n\n\n\nok', 'test\n\n\n\n\n\n\n\n\n\n\n\n\n\nok', 0, NULL, '', '0', 0, 85, 0, '', NULL),
(450, 1387894136, 'test', 'test', 0, NULL, '', '0', 0, 85, 0, '', NULL),
(451, 1387894137, 'k', 'k', 0, NULL, '', '0', 0, 85, 0, '', NULL),
(452, 1387894144, 'test \n\n\n\n\n\n\n\n\n\n\n\n\n\ng', 'test \n\n\n\n\n\n\n\n\n\n\n\n\n\ng', 0, NULL, '', '0', 0, 85, 0, '', NULL),
(453, 1387894715, 'test #yolo #swag #test', 'test #yolo #swag #test', 0, NULL, '', '0', 0, 80, 3, '', 1390492436),
(454, 1387899241, '#not even close', '#not even close', 0, NULL, '', '0', 0, 80, 1, '', 1390492436),
(455, 1387918509, 'Test', 'Test', 0, NULL, '', '0', 0, 0, 1, '', NULL),
(456, 1388254917, 'Test &quot;do these backslashes really occur&quot;..', 'Test &quot;do these backslashes really occur&quot;..', 0, NULL, '', '0', 0, 0, 1, '', NULL),
(457, 1388959480, 'wrong #test', 'wrong #test', 0, NULL, '', '0', 0, 48, 0, '', NULL),
(458, 1388959486, 'wrong #test #test2', 'wrong #test #test2', 0, NULL, '', '0', 0, 48, 0, '', NULL),
(459, 1388961607, '#test #test', '#test #test', 0, NULL, '', '0', 0, 80, 0, '', 1390492433),
(460, 1388962900, '#test #test2', '#test #test2', 0, NULL, '', '0', 0, 80, 0, '', 1390492430),
(461, 1388963344, '#test', '#test', 0, NULL, '', '0', 0, 80, 0, '', 1390492429),
(462, 1388964069, 'Catz chef should give food advice to other colleges -- starting with New college', 'Catz chef should give food advice to other colleges -- starting with New collegeCatz chef should give food advice to other colleges -- starting with New collegeCatz chef should give food advice to other colleges -- starting with New collegeCatz chef should give food advice to other colleges -- starting with New collegeCatz chef should give food advice to other colleges -- starting with New collegeCatz chef should give food advice to other colleges -- starting with New college', 0, NULL, '', '0', 0, 80, 0, '', NULL),
(463, 1388964081, 'Catz chef should give food advice to other colleges -- starting with New college', 'Catz chef should give food advice to other colleges -- starting with New collegeCatz chef should give food advice to other colleges -- starting with New collegeCatz chef should give food advice to other colleges -- starting with New collegeCatz chef should give food advice to other colleges -- starting with New collegeCatz chef should give food advice to other colleges -- starting with New collegeCatz chef should give food advice to other colleges -- starting with New collegeCatz chef should give food advice to other colleges -- starting with New collegeCatz chef should give food advice to other colleges -- starting with New collegeCatz chef should give food advice to other colleges -- starting with New collegeCatz chef should give food advice to other colleges -- starting with New college', 0, NULL, '', '0', 0, 80, 0, '', NULL),
(464, 1388964488, '#niche', '#niche', 0, NULL, '', '0', 0, 80, 0, '', 1390492421),
(465, 1388964505, '#test', '#test', 0, NULL, '', '0', 0, 80, 0, '', 1390492420),
(466, 1388964603, '.hashtag', '.hashtag', 0, NULL, '', '0', 0, 80, 0, '', 1390492419),
(467, 1388964612, '.hashtag', '.hashtag', 0, NULL, '', '0', 0, 80, 0, '', 1390492418),
(468, 1388965073, '#test', '#test', 0, NULL, '', '0', 0, 80, 0, '', 1390492416),
(469, 1388965113, '#testing', '#testing', 0, NULL, '', '0', 0, 80, 0, '', 1390492416),
(470, 1388966464, '#test', '#test', 0, NULL, '', '0', 0, 80, 0, '', 1390492415),
(471, 1388966483, '#test #test', '#test #test', 0, NULL, '', '0', 0, 80, 0, '', 1390492414),
(472, 1388966502, 'new #test #testing #ma', 'new #test #testing #ma', 0, NULL, '', '0', 0, 80, 0, '', 1390492413),
(473, 1389123239, '#test #test', '#test #test', 0, NULL, '', '0', 0, 80, 0, '', 1390492412),
(474, 1389123667, 'd#test', 'd#test', 0, NULL, '', '0', 0, 80, 0, '', 1390492411),
(475, 1389123688, '#test #test #test', '#test #test #test', 0, NULL, '', '0', 0, 80, 0, '', 1390492410),
(476, 1389123715, '#david #test david #try', '#david #test david #try', 0, NULL, '', '0', 0, 80, 0, '', 1390492408),
(477, 1389123887, '#test test #test', '#test test #test', 0, NULL, '', '0', 0, 80, 0, '', 1390492406),
(478, 1389123900, '#david #test david #try', '#david #test david #try', 0, NULL, '', '0', 0, 80, 0, '', 1390492405),
(479, 1389124269, '#test #123 123', '#test #123 123', 0, NULL, '', '0', 0, 80, 0, '', 1390492403),
(480, 1389144150, '#lowhangingfruit \n&quot;facebook for project sharing&quot; -- currently, tons of', '#lowhangingfruit \n&quot;facebook for project sharing&quot; -- currently, tons of', 0, NULL, '', '0', 0, 43, 1, '', NULL),
(481, 1389144192, 'asd\nfasdf', 'asd\nfasdf', 0, NULL, '', '0', 0, 43, 1, '', 1390190728),
(482, 1389144204, 'asdfsa\ndfasdf', 'asdfsa\ndfasdf', 0, NULL, '', '0', 0, 43, 4, '', 1390190728),
(483, 1389234608, 'quadrotor metal detector', 'quadrotor metal detector', 0, NULL, '', '0', 0, 54, 1, '', NULL),
(484, 1389234650, 'quadrotor drone metal detector -- combs beach', 'quadrotor drone metal detector -- combs beach', 0, NULL, '', '0', 0, 54, 0, '', NULL),
(485, 1389234663, 'quadrotor drone metal detector: combs beach', 'quadrotor drone metal detector: combs beach', 0, NULL, '', '0', 0, 54, 0, '', NULL),
(486, 1389235140, 'http://www.yahoo.com/', 'http://www.yahoo.com/', 0, NULL, '', '0', 0, 88, 0, '', NULL),
(487, 1389236148, 'links should open in new tab', 'links should open in new tab', 0, NULL, '', '0', 0, 90, 0, '', NULL),
(488, 1389236159, 'release stable branch without connection feature', 'release stable branch without connection feature', 0, NULL, '', '0', 0, 90, 0, '', NULL),
(489, 1389236194, 'you should be able to paste in a list of ideas. Double line breaks should be con', 'you should be able to paste in a list of ideas. Double line breaks should be considered separator', 0, NULL, '', '0', 0, 90, 0, '', NULL),
(490, 1389236223, 'if the text in the input box is selected, and you press enter, it comes out blan', 'if the text in the input box is selected, and you press enter, it comes out blank', 0, NULL, '', '0', 0, 90, 0, '', NULL),
(491, 1389236585, 'make homepage say: @Nuance allow dragon users to change search engine from Bing ', 'make homepage say: @Nuance allow dragon users to change search engine from Bing to Google', 0, NULL, '', '0', 0, 90, 0, '', NULL),
(492, 1389236597, 'make homepg search box allow @Nuance allow dragon users to change search engine ', 'make homepg search box allow @Nuance allow dragon users to change search engine from Bing to Google', 0, NULL, '', '0', 0, 90, 0, '', NULL),
(493, 1389236612, 'rediscover joy of programming', 'rediscover joy of programming', 0, NULL, '', '0', 0, 92, 0, '', NULL),
(494, 1389237304, 'system to link ideas to each other â€“ apply to government, Hackett on Scott my ', 'system to link ideas to each other â€“ apply to government, Hackett on Scott my and more', 0, NULL, '', '0', 0, 14, 0, '', NULL),
(495, 1389237324, 'system collaboratively link ideas to each other â€“ apply to hack on, government', 'system collaboratively link ideas to each other â€“ apply to hack on, government and more', 0, NULL, '', '0', 0, 14, 0, '', NULL),
(496, 1389237326, 'system collaboratively link ideas to each other â€“ apply to hack on, government', 'system collaboratively link ideas to each other â€“ apply to hack on, government and more', 0, NULL, '', '0', 0, 14, 0, '', NULL),
(497, 1389237348, 'system collaboratively link ideas to each other â€“ apply to hack on, government', 'system collaboratively link ideas to each other â€“ apply to hack on, government and more', 0, NULL, '', '0', 0, 93, 0, '', NULL),
(498, 1389321225, 'idea -- kjkjsdfds ~jacob', 'idea -- kjkjsdfds ~jacob', 0, NULL, '', '0', 0, 43, 0, '', 1390190727),
(499, 1389321249, 'as -- sadf s', 'as -- sadf s', 0, NULL, '', 'Jacob', 0, 43, 0, '', 1390190727),
(500, 1389321272, 'asdf -- asdf asdf', 'asdf -- asdf asdf', 0, NULL, '', '<a href=''mailto:jcole@mit.edu''>Jacob</a>', 0, 43, 0, '', 1390190726),
(501, 1389321359, 'asdfa #~jacob', 'asdfa #~jacob', 0, NULL, '', '<a href=''mailto:jcole@mit.edu''>Jacob</a>', 0, 43, 0, '', 1390190725),
(502, 1389321386, 'asadf #~jcole@mit', 'asadf #~jcole@mit', 0, NULL, '', '<a href=''mailto:jcole@mit.edu''>Jacob</a>', 0, 43, 0, '', 1390190721),
(503, 1389321690, 'asdf -- asdf asdf', 'asdf -- asdf asdf', 0, NULL, '', '0', 0, 43, 0, '', 1390190721),
(504, 1389358389, 'long idea -- aoeuaoeuaoeaoeuaoeuaoeaoeuaoeuaoeaoeuaoeuaoeaoeuaoeuaoeaoeuaoeuaoea', 'long idea -- aoeuaoeuaoeaoeuaoeuaoeaoeuaoeuaoeaoeuaoeuaoeaoeuaoeuaoeaoeuaoeuaoeaoeuaoeuaoeaoeuaoeuaoeaoeuaoeuaoeaoeuaoeuaoeaoeuaoeuaoeaoeuaoeuaoeaoeuaoeuaoe', 0, NULL, '', '0', 0, 88, 0, '', NULL),
(505, 1389358433, 'long idea2 -- aoeuaoeu aoeu aoeuaoeu aoeu aoeuaoeu aoeu aoeuaoeu aoeu aoeuaoeu a', 'long idea2 -- aoeuaoeu aoeu aoeuaoeu aoeu aoeuaoeu aoeu aoeuaoeu aoeu aoeuaoeu aoeu aoeuaoeu aoeu aoeuaoeu aoeu aoeuaoeu aoeu aoeuaoeu aoeu aoeuaoeu aoeu aoeuaoeu aoeu aoeuaoeu aoeu aoeuaoeu aoeu aoeuaoeu aoeu aoeuaoeu aoeu aoeuaoeu aoeu aoeuaoeu aoeu aoeuaoeu aoeu aoeuaoeu aoeu aoeuaoeu aoeu aoeuaoeu aoeu', 0, NULL, '', '0', 0, 88, 0, '', NULL),
(506, 1389358493, 'long idea 3', 'long idea 3', 0, NULL, '', '0', 0, 88, 0, '', NULL),
(507, 1389358504, 'oaoeu -- aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu a', 'oaoeu -- aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu HAI', 0, NULL, '', '0', 0, 88, 0, '', NULL),
(508, 1389358521, 'oaoeu -- aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu a', 'oaoeu -- aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu eu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu eu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu aoeu HAI', 0, NULL, '', '0', 0, 88, 0, '', NULL),
(509, 1389393403, 'Traffic Guru', 'Traffic Guru --Traffic Guru app http://techland.time.com/2011/08/29/traffic-app-by-mit-and-princeton-could-change-driving-forever/. This allows drivers to feed each other information about upcoming traffic lights, and how fast one would need to go to make the light. It could be improved by hooking it up to actual traffic signals.', 0, NULL, '', '0', 0, 94, 0, '', NULL),
(510, 1389393410, 'Connect Projects with Ideas', 'Connect Projects with Ideas -- combine the people tab with hotlinks or something for quick access to list of skills and such #meta', 0, NULL, '', '0', 0, 94, 0, '', NULL),
(511, 1389393426, 'When to Leave', 'When to Leave -- App that tells you when to leave/what route to take so you donâ€™t get stuck in as bad of traffic. ~jcole', 1, NULL, '', '0', 0, 94, 0, '', NULL),
(512, 1389393438, 'Social Carpooling App', 'Social Carpooling App -- App that tells you whether anyone else in your vicinity is taking a cab to the same place or in the same direction. Finally, what if google maps had an integrated call a cab button when you searched directions. And/or what if this were integrated with Social Rideshare/Cabshare? ~jcole', 2, NULL, '', '0', 0, 94, 1, '', NULL),
(513, 1389393451, 'Complaint Stereotyper', 'Complaint Stereotyper -- This looks at complaints from sales data and find clusters of these complaints that are related to each other. Then, it would use unsupervised learning to find stereotypes of problems or usage patterns. ~jcole', 0, NULL, '', '0', 0, 94, 0, '', NULL),
(514, 1389393464, 'Car Hero', 'Car Hero -- App that grades your driving via accelerometer. With more car data, you could do this even more effectively, via machine learning against crash records ~jcole', 0, NULL, '', '0', 0, 94, 0, '', NULL),
(515, 1389393481, 'Playlist for Life', 'Playlist for Life -- &quot;playlistforlife.com -- looks at what you''re doing on pc and other devices and gives you the music for it! Or just compiles peopleâ€™s coding playlists, jogging playlists, etc and lets you look them up, mix and match, etc. Could use stereotyping after learning to predict tastes. ~jcole. \n\n As an addendum, possibly be prodded to change playlist depending on activity of accelerometer in mobile device. Eg, when running, when driving/working. ~jaredlwon', 4, NULL, '', '0', 0, 94, 2, '', NULL),
(516, 1389394131, 'CabShare', 'CabShare -- app that tells you if any other people looking for a cab are headed in the same direction', 1, NULL, '', '0', 0, 94, 3, '', NULL),
(517, 1389397089, 'kjk', 'kjk', 0, NULL, '', '0', 0, 88, 0, '', NULL),
(518, 1389397116, 'jkkj', 'jkkj', 0, NULL, '', '0', 0, 88, 0, '', NULL),
(519, 1389397123, 'hjh', 'hjh', 0, NULL, '', '0', 0, 88, 0, '', NULL),
(520, 1389397190, 'dhihdi', 'dhihdi', 0, NULL, '', '0', 0, 94, 0, '', 1390250275),
(521, 1389397195, 'thd', 'thd', 0, NULL, '', '0', 0, 94, 0, '', 1390250273),
(522, 1389397330, 'tht', 'tht', 0, NULL, '', '0', 0, 88, 0, '', NULL),
(523, 1389397539, 'jhjk', 'jhjk', 0, NULL, '', '0', 0, 88, 0, '', NULL),
(524, 1389397567, 'kkj', 'kkj', 0, NULL, '', '0', 0, 88, 0, '', NULL),
(525, 1389397686, 'jhjh', 'jhjh', 0, NULL, '', '<a href=''mailto:jcole@mit.edu''>kjkj</a>', 0, 88, 0, '', NULL),
(526, 1389397825, '#~sdf', '#~sdf', 0, NULL, '', '<a href=''mailto:jcole@mit.edu''>kjkj</a>', 0, 43, 0, '', 1390190720),
(527, 1389397864, 'kjkj', 'kjkj -- asdf', 0, NULL, '', '<a href=''mailto:jcole@mit.edu''>kjkj</a>', 0, 88, 0, '', NULL),
(528, 1389397867, 'kjkj : asdfasdf', 'kjkj : asdfasdf', 0, NULL, '', '<a href=''mailto:jcole@mit.edu''>kjkj</a>', 0, 88, 0, '', NULL),
(529, 1389421484, 'aoeu', 'aoeu -- #cat ~pers', 0, NULL, '', '<a href=''mailto:jcole@mit.edu''>kjkj</a>', 0, 88, 0, '', NULL),
(530, 1389838715, 'dff ~sdf', 'dff ~sdf', 0, NULL, '', '0', 0, 43, 0, '', 1390190718),
(531, 1389839311, 'asdfasdf', 'asdfasdf', 0, NULL, '', '<a href=''mailto:lambertc@mit.edu''>Chase Lambert</a>', 0, 43, 0, '', 1390190717),
(532, 1389924035, 'asdfsadflkj', 'asdfsadflkj -- ~jcole', 0, NULL, '', '0', 0, 43, 0, '', 1390190717),
(533, 1389924448, 'laksfjlskfd', 'laksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fh', 0, NULL, '', '<a href=''mailto:undefined''>undefined</a>', 0, 91, 0, '', NULL),
(534, 1389924461, 'laksfjlskfd', 'laksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fh', 0, NULL, '', '<a href=''mailto:undefined''>undefined</a>', 0, 91, 0, '', NULL),
(535, 1389924464, 'laksfjlskfd', 'laksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fh', 0, NULL, '', '<a href=''mailto:undefined''>undefined</a>', 0, 91, 0, '', NULL),
(536, 1389924469, 'laksfjlskfd', 'laksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fhlaksfjlskfd -- asdfasdfjasdjhfakjsf hlhas dh jhasl fkhaslkj fhas dfhaskjl fhkasj dhfa fkla shklasj hsjhalash fkjashl flkasjh fklas fh', 0, NULL, '', '<a href=''mailto:undefined''>undefined</a>', 0, 91, 0, '', NULL),
(537, 1389928052, 'sdfg', 'sdfg', 0, NULL, '', '', 0, 43, 0, '', 1390190715),
(538, 1389928059, 'asdf', 'asdf -- ~g', 0, NULL, '', '', 0, 43, 0, '', 1390190701),
(539, 1389928063, 'asdf', 'asdf', 0, NULL, '', '', 0, 43, 0, '', 1390190694),
(540, 1389928069, 'kjkj', 'kjkj', 0, NULL, '', 'jcole', 0, 43, 0, '', 1390190690),
(541, 1389928083, 'ghg', 'ghg ~jcole', 0, NULL, '', 'jcole', 0, 43, 0, '', 1390190231),
(542, 1389932677, 'asdf', 'asdf -- ~jcole asdf', 2, NULL, '', '<a href=''mailto:undefined''>undefined</a>', 0, 43, 0, '', 1390190221),
(543, 1389932695, 'jknw', 'jknw -- ~kola', 1, NULL, '', '<a href=''mailto:undefined''>undefined</a>', 0, 43, 0, '', 1390190203),
(544, 1389932740, 'a', 'a -- ~o', 0, NULL, '', '<a href=''mailto:undefined''>undefined</a>', 0, 43, 0, '', 1390190194),
(545, 1389932791, 'asdf', 'asdf -- ~ee ~jcole', 0, NULL, '', 'jcole', 0, 43, 0, '', 1390190173),
(546, 1389932792, '~jcole', '~jcole', 0, NULL, '', 'jcole', 0, 43, 0, '', 1390190167),
(547, 1389932794, '~jcole', '~jcole', 0, NULL, '', 'jcole', 0, 43, 0, '', 1390190191),
(548, 1389932852, 'kjkj ~jcole asdf', 'kjkj ~jcole asdf', 0, NULL, '', 'jcole', 0, 43, 0, '', 1390190164),
(549, 1389932863, 'kjkj ~er asdf', 'kjkj ~er asdf ~jcole', 0, NULL, '', 'jcole', 0, 43, 0, '', 1390190166),
(550, 1389932887, 'ert ~jio', 'ert ~jio  ~jcole', 0, NULL, '', 'jcole', 0, 43, 0, '', 1390190163),
(551, 1389935353, 'oeu', 'oeu ~jcole', 0, NULL, '', 'jcole', 0, 43, 0, '', 1390190161),
(552, 1389935595, 'oeu', 'oeu ~jcole', 0, NULL, '', 'jcole', 0, 43, 0, '', 1390189903),
(553, 1389935598, 'oeu ~hth', 'oeu ~hth ~jcole', 2, NULL, '', 'jcole', 0, 43, 0, '', 1390189925),
(554, 1389936517, '~jcole', '~jcole', 1, NULL, '', 'jcole', 0, 94, 1, '', 1390250272),
(555, 1389948323, '~jcole', '~jcole', 0, NULL, '', 'jcole', 0, 94, 0, '', 1390250270),
(556, 1390249693, 'new', 'new', 0, NULL, '', '', 0, 43, 0, '', 1390249697),
(557, 1390249729, '&quot;facebook for project sharing&quot;', '&quot;facebook for project sharing&quot; -- currently, tons of people lack homepages, to their detriment, as expressed at the bottom of minimalisthomepages.tk. Asana is poised to be the enabler for this', 0, NULL, '', '', 0, 43, 0, '', NULL),
(558, 1390249810, '&quot;facebook for project sharing&quot;', '&quot;facebook for project sharing&quot; -- currently, tons of people lack homepages, to their detriment, as expressed at the bottom of minimalisthomepages.tk. #Asana is poised to be the enabler for this', 2, NULL, '', '', 0, 43, 0, '', NULL),
(559, 1390250329, 'Self Driving Car that picks you up #taxi', 'Self Driving Car that picks you up #taxi', 1, NULL, '', '', 0, 94, 0, '', NULL),
(560, 1390251830, 'playlistforlife.com', 'playlistforlife.com -- looks at what you''re doing on pc and other devices and gives you the music for it! Or just compiles peopleâ€™s coding playlists, jogging playlists, etc and lets you look them up, mix and match, etc. Could use stereotyping after learning to predict tastesplaylistforlife.com -- looks at what you''re doing on pc and other devices and gives you the music for it! Or just compiles peopleâ€™s coding playlists, jogging playlists, etc and lets you look them up, mix and match, etc. Could use stereotyping after learning to predict tastesplaylistforlife.com -- looks at what you''re doing on pc and other devices and gives you the music for it! Or just compiles peopleâ€™s coding playlists, jogging playlists, etc and lets you look them up, mix and match, etc. Could use stereotyping after learning to predict tastes ~vpontis', 0, NULL, '', 'vpontis', 0, 94, 0, '', NULL);
INSERT INTO `post_ideas_mitsugg` (`pid`, `time`, `title`, `body`, `status`, `progress`, `metric`, `uid`, `parent`, `mapid`, `upvotes`, `path`, `deleted_time`) VALUES
(561, 1390251843, 'playlistforlife.com', 'playlistforlife.com -- looks at what you''re doing on pc and other devices and gives you the music for it! Or just compiles peopleâ€™s coding playlists, jogging playlists, etc and lets you look them up, mix and match, etc. Could use stereotyping after learning to predict tastesplaylistforlife.com -- looks at what you''re doing on pc and other devices and gives you the music for it! Or just compiles peopleâ€™s coding playlists, jogging playlists, etc and lets you look them up, mix and match, etc. Could use stereotyping after learning to predict tastesplaylistforlife.com -- looks at what you''re doing on pc and other devices and gives you the music for it! Or just compiles peopleâ€™s coding playlists, jogging playlists, etc and lets you look them up, mix and match, etc. Could use stereotyping after learning to predict tastesplaylistforlife.com -- looks at what you''re doing on pc and other devices and gives you the music for it! Or just compiles peopleâ€™s coding playlists, jogging playlists, etc and lets you look them up, mix and match, etc. Could use stereotyping after learning to predict tastesplaylistforlife.com -- looks at what you''re doing on pc and other devices and gives you the music for it! Or just compiles peopleâ€™s coding playlists, jogging playlists, etc and lets you look them up, mix and match, etc. Could use stereotyping after learning to predict tastesplaylistforlife.com -- looks at what you''re doing on pc and other devices and gives you the music for it! Or just compiles peopleâ€™s coding playlists, jogging playlists, etc and lets you look them up, mix and match, etc. Could use stereotyping after learning to predict tastesplaylistforlife.com -- looks at what you''re doing on pc and other devices and gives you the music for it! Or just compiles peopleâ€™s coding playlists, jogging playlists, etc and lets you look them up, mix and match, etc. Could use stereotyping after learning to predict tastesplaylistforlife.com -- looks at what you''re doing on pc and other devices and gives you the music for it! Or just compiles peopleâ€™s coding playlists, jogging playlists, etc and lets you look them up, mix and match, etc. Could use stereotyping after learning to predict tastesplaylistforlife.com -- looks at what you''re doing on pc and other devices and gives you the music for it! Or just compiles peopleâ€™s coding playlists, jogging playlists, etc and lets you look them up, mix and match, etc. Could use stereotyping after learning to predict tastesplaylistforlife.com -- looks at what you''re doing on pc and other devices and gives you the music for it! Or just compiles peopleâ€™s coding playlists, jogging playlists, etc and lets you look them up, mix and match, etc. Could use stereotyping after learning to predict tastesplaylistforlife.com -- looks at what you''re doing on pc and other devices and gives you the music for it! Or just compiles peopleâ€™s coding playlists, jogging playlists, etc and lets you look them up, mix and match, etc. Could use stereotyping after learning to predict tastesplaylistforlife.com -- looks at what you''re doing on pc and other devices and gives you the music for it! Or just compiles peopleâ€™s coding playlists, jogging playlists, etc and lets you look them up, mix and match, etc. Could use stereotyping after learning to predict tastesplaylistforlife.com -- looks at what you''re doing on pc and other devices and gives you the music for it! Or just compiles peopleâ€™s coding playlists, jogging playlists, etc and lets you look them up, mix and match, etc. Could use stereotyping after learning to predict tastesplaylistforlife.com -- looks at what you''re doing on pc and other devices and gives you the music for it! Or just compiles peopleâ€™s coding playlists, jogging playlists, etc and lets you look them up, mix and match, etc. Could use stereotyping after learning to predict tastesplaylistforlife.com -- looks at what you''re doing on pc and other devices and gives you the music for it! Or just compiles peopleâ€™s coding playlists, jogging playlists, etc and lets you look them up, mix and match, etc. Could use stereotyping after learning to predict tastes ~vpontis', 0, NULL, '', 'vpontis', 0, 94, 0, '', 1390251853),
(562, 1390492479, 'cure homelessness', 'cure homelessness ~vpontis', 0, NULL, '', 'vpontis', 0, 95, 0, '', NULL),
(563, 1390492509, 'cure repetitive strain injury', 'cure repetitive strain injury ~jcole@mit.edu', 0, NULL, '', 'jcole@mit.edu', 0, 95, 0, '', NULL),
(564, 1390492524, 'cure poverty', 'cure poverty ~jcole@mit.edu', 0, NULL, '', 'jcole@mit.edu', 0, 95, 0, '', NULL),
(565, 1390525719, 'new idea', 'new idea ~jcole@mit.edu', 0, NULL, '', 'jcole@mit.edu', 0, 43, 0, '', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `post_ideas_unused`
--

CREATE TABLE IF NOT EXISTS `post_ideas_unused` (
  `pid` int(11) NOT NULL AUTO_INCREMENT,
  `time` bigint(20) NOT NULL,
  `body` text NOT NULL,
  `status` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `post_ideas_unused`
--

INSERT INTO `post_ideas_unused` (`pid`, `time`, `body`, `status`, `progress`, `metric`, `uid`) VALUES
